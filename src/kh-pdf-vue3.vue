...
const renderPDF = async () => {
  ...
  for (let i = 0; i < totalPages.value; i++) {
    try {
      ...
      var scale =
        ((canvas.parentNode as HTMLDivElement).clientWidth - 4) / viewport.width
...
<template>
  <div class="pdf-vue3-main"
       style="height: 100%; position: relative; min-height: 10px">
    <div class="pdf-vue3-container"
         style="height: 100%">
      <div ref="scroller"
           ...
           @scroll="handleScroll">
        <div class="pdf-vue3-canvas-container"
             ref="container"
             style="margin: 0 auto"
             :style="{
    ...
    <div class="pdf-vue3-progress"
        ...
        pointer-events: none;
      ">
      <slot v-if="slots.progress"
            name="progress"
            :loadRatio="loadRatio"></slot>
      <div v-else
    ...
    <div class="pdf-vue3-pageTooltip"
        ...
        pointer-events: none;
      ">
      <slot v-if="slots.pageTooltip"
            name="pageTooltip"
            :currentPage="currentPage"
            :totalPages="totalPages"></slot>
      <div v-else
           style="
          padding: 4px 8px;
    ...
    <div class="pdf-vue3-backToTopBtn"
      ...
      "
        ...
        scrollOffset > props.scrollThreshold
          ...
          : undefined
      ">
      <slot v-if="slots.backToTopBtn"
            name="backToTopBtn"
            :scrollOffset="scrollOffset"></slot>
      <div v-else
           style="
          width: 50px;
          height: 50px;
